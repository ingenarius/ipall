...
function myClickListener(e) {
    ...
    return eventIsFiredFromElement;
}    
*/
...
//        this.eventIsFiredFromElement = myClickListener(e);
    ...
    startListener: function() {
        ...
        this.menu.getElements('a').each(function(item) {
            //item.href += this.options.element.innerHTML;
...
window.addEvent('domready', function() { var context = new ContextMenu({ targets: 'span.prefix', menu: 'contextmenu' }); });
/* usage
...
window.addEvent('domready', function() {
    var context = new ContextMenu({
        ...
        menu: 'contextmenu',
        actions: {
            view: function(element,ref) {
                //var url = element.getAttribute("url");
                //var id = element.getAttribute("class");
                alert('fuck you');
                //element.setAttribute("link", url+'?'+id); 
                //element.setAttribute("className", "smoothbox"); 
            },
            print: function(element,ref) {
                element.setAttribute("class", "smoothbox");  
                element.setAttribute("className", "smoothbox");  
            }
        }
    });
